  ...
  return (
    <>
      <Router>
        ...
        <footer>
          <p>Desenvolvido por Lucas Moura Corazim</p>
          <p><a className="link" href="https://github.com/mouraCorazim">Github</a></p>
          <p>e-mail: lucamouracorazim1@gmail.com</p>
          <p>celular(whatsapp): (11)96847-5194</p>
        </footer>
      </Router>
    </>
  );
